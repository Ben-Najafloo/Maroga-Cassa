            ...
            <section class="relative pt-5">
                <div class="w-full mx-auto px-4 sm:px-6 lg:px-0">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
                        <div class="img">
                            <div class="img-box h-full max-lg:mx-auto p-2">
                        ...
                        <div
                            ...
                            <div class="data w-full max-w-xl">
                                ...
                                <h2 class="font-manrope font-bold text-3xl leading-10 text-gray-200 mb-2 capitalize">
                                    {product.title}
                                </h2>
                                <div class="flex flex-col sm:flex-row sm:items-center mb-6">
                                    <h6 class="font-manrope font-semibold text-2xl leading-9 text-gray-100 pr-5 sm:border-r border-gray-200 mr-5">
                                        ${product.price}
                                    </h6>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="pl-2 font-normal leading-7 text-gray-400 text-sm ">Rate: {product.rating.rate}</span>
                                    </div>
                                ...
                                <Link href='/'
                                    class="mt-4 text-center w-full px-3 py-2 rounded-2xl bg-gray-400 flex items-center justify-center text-lg text-black shadow-sm transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
                                    &larr; Back
                                </Link>
                            </div>
                        </div>
